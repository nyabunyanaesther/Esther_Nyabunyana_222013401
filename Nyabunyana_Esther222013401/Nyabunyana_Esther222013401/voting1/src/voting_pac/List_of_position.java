...
public class List_of_position extends JFrame {
...
public List_of_position() {
	...
	scrollPane.setBounds(10, 64, 366, 200);
	contentPane.add(scrollPane);
	//My_test obj=new My_test();// with test data
	my_mysql obj=new my_mysql();
	
	
	 JLabel titles=new JLabel("LIST OF  POSITIONS ABLE TO VOTE");
	 contentPane.add(titles);
	 titles.setBounds(10, 20, 300, 30);
		
	String[] column= {"POSITION CODE","TITLE"};
...
////////////
String[][] data = new String[7][2]; // [rows][columns]
